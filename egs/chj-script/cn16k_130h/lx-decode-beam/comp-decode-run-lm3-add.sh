...
arpa_lmfile=$datadir/targets/train.char.lm3
lm_order=3
fst_lmfile=$datadir/targets/arpa_cn_2.fst
...
#		continue
      ...
      $name --apply_log=true --lm_order=$lm_order  --beam=$beam_num  "ark:$data/output.ark" $lmfile $outark 2>$log || exit 1;
