...
#-------------与程序有关的
runname="lstm_s12_v2_2015-3-14-11_d3cec1024r800tg0sp0_5_1lr0.001hf0.3"
runname="lstm_s1_v2_2015-5-27-16_d1cec800r500tg5b20lr0.001hf0.3"
f_nnet_proto=""
...
if [ $stage -le $cnt ]; then
  ...
  if ((nn_depth>0)); then
	$cuda_cmd $dir/log/pretrain_lstm.log  $myscript/pretrain_lstm_mullayer.sh  \
