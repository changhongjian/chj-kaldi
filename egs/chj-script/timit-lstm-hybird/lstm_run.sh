...
train_tool="chj_lstm_1"  #训练的程序

#-------------与程序有关的
runname="lstm_s12_v2_2015-3-14-11_cec1500r1000tg0sp0_5_1lr0.01hf0.3"
f_nnet_proto="lstm_s12cec1500r1000_sp0_5_1___2"
...
if [ $stage -le $cnt ]; then
  ...
  --max_iters $max_iters --num_stream $num_stream --newbob_acc $newbob_acc \
  --halving_factor $halving_factor  --batch_size $batch_size --targets_delay $targets_delay  \
...
#  $myscript/decode.sh --nj 20 --cmd "$decode_cmd" --nnet_forward "nnet-lstm-forward"  --acwt 0.2 \
#    --feature_transform $feature_transform --nnet $dir/final.nnet.txt  \
