...
#include "nnet/nnet-time-shift.h"
#include "nnet/nnet-transmit-component.h"
#include "nnet/bd-nnet-lstm-projected-streams.h"
#include "nnet/bd-nnet-blstm-projected-streams.h"
...
//添加的代码
{ Component::myTimeShift, "<TimeShift>"},
{ Component::myLstmProjected, "<LstmProjected>"},
{ Component::myTransmitComponent, "<Transmit>"},
{ Component::myLstmProjectedStreams, "<LstmProjectedStreams>"},
{ Component::myBLstmProjectedStreams, "<BLstmProjectedStreams>"},
...
Component* Component::NewComponentOfType(ComponentType comp_type,
  ...
  switch (comp_type) {
    ...
    case Component::kParallelComponent :
      ...
      break;
//添加的代码
    case Component::myTimeShift :
      ans = new TimeShift(input_dim, output_dim);
      break;
    case Component::myLstmProjected :
      ans = new LstmProjected(input_dim, output_dim);
      break;
    case Component::myTransmitComponent :
      ans = new TransmitComponent(input_dim, output_dim);
      break;
    case Component::myLstmProjectedStreams :
      ans = new LstmProjectedStreams(input_dim, output_dim);
      break;
    case Component::myBLstmProjectedStreams :
